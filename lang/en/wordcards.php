...
$string['freemodeintropara1'] = "Choose the word pool you want to use, from ... [JH to amend or delete]";
$string['freemodeintropara2'] = "Choose the activity type ... [JH to amend or delete]";
$string['freemodeintropara3'] = "No attempts or grades wil be recorded ... [JH to amend or delete]";
