...
$string['congratsitsover'] = '<div  style="text-align: center;">You have completed this activity. Feel free to go back to the practice and review tabs to practice more!</div>';
...
$string['finishscatterin'] = '<div style="text-align: center;">Congratulations! <br/> You finished the practice in [[time]]</div>';
...
$string['localscatterfinished'] = 'You finished the local practice in {$a->seconds} seconds.';
