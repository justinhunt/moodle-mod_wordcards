...
$string['title_vocablist'] = 'Check the Selected Words';
...
$string['instructions_speechcards'] = 'Tap the button and speak the word(s) that you see on the card. Speak slowly and clearly.';
$string['instructions_vocablist'] = 'Check the words that have been chosen for the activity. Tap the word card or press the \'meaning\' button to see what each word means. When you are ready press \'Begin\' and test how well you remember.';