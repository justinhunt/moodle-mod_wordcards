...
$string['globaltermcount'] = 'Review word set size';
$string['gotit'] = 'Got it';
...
$string['finishedscattermsg'] = 'Finished message';
...
$string['localtermcount'] = 'Practice word set size';
...
$string['localpracticetype'] = 'Practice learning activity';
$string['globalpracticetype'] = 'Review learning activity';
