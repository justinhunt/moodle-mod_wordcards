...
$string['learningactivityoptions_desc'] = 'Configure how the different learning activity types behave in WordCards.';
$string['stepsmodeoptions'] = 'Steps Mode Options';
$string['stepsmodeoptions_desc'] = 'Choose the learning activity for each step when in steps mode. Note that you have the choice of using the new words pool, or review words pool in the learning activity.';
