...
$string['localscatterfinished'] = '新出用語の練習は{$a->seconds} 秒で完成しました。';
$string['finishedscattermsg'] = '練習完成のメッセージ';
$string['finishedscattermsg_help'] = '新出用語練習か復習が完成後、表示するメッセージです。[[time]]の記号で完成する時間を表示できます。';
$string['localtermcount'] = '新出用語の数';
$string['loading'] = 'ロード中';
